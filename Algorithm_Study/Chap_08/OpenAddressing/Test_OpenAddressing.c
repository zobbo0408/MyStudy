...
int main()
{
	...
	OAHT_Set((&HT), "IBM", "Microsoft Corporation");
	OAHT_Set((&HT), "ORCL", "Microsoft Corporation");
	OAHT_Set((&HT), "CSCO", "Microsoft Corporation");
	OAHT_Set((&HT), "GOOG", "Microsoft Corporation");
	OAHT_Set((&HT), "YHOO", "Microsoft Corporation");
	OAHT_Set((&HT), "NOVL", "Microsoft Corporation");
