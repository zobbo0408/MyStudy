...
public:
	...
	void print_out_friend_element() {
		cout << "friend 클래스 템플릿 호출 템플릿 형식 매개 변수 값 : " << object->first << endl;
	};
...
int main(){
	...
	caller_int_obj.print_out_friend_element();
	caller_string_obj.print_out_friend_element();
